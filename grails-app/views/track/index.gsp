		...
		<div id="list-track" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="artist" title="${message(code: 'track.artist.label', default: 'Artist')}" />
					
						<g:sortableColumn property="album" title="${message(code: 'track.album.label', default: 'Album')}" />
