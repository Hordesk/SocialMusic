...
<body>
<a href="#list-artiste" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-artiste" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tbody>
        <g:each in="${artisteInstanceList}" status="i" var="artisteInstance">
    ...
    <div class="pagination">
        <g:paginate total="${artisteInstanceCount ?: 0}"/>
    </div>
</div>
</body>
</html>
